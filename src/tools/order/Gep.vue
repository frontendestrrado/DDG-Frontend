<template>
    <div>
      ...
      <CustomerApplicationGep></CustomerApplicationGep>
      <div class="title">2/5 Compliance Questionnaire</div>
      <KYCGep></KYCGep>
      <div class="title">3/5 THIRD PARTY FUND DECLARATION</div>
      <LetterOfWishesGep></LetterOfWishesGep>
      <div class="title">4/5 NON-DISCLOSURE AGREEMENT</div>
      <PDPAMemoGep></PDPAMemoGep>
      <div class="title">5/5 Document Checklist</div>
      <DocumentChecklistGep @getOrderDetail="getOrderDetail" @onSelect='onSelect'></DocumentChecklistGep>
