<template>
  <div class="CreateOrder bodybox">
    <van-cell is-link center @click="$store.commit('changePage',{tabbar: '/CustomerApplication', title: '1/5 Customer Application'});$router.push('/CustomerApplication?from=create')">
    ...
    <van-cell is-link center @click="$store.commit('changePage',{tabbar: '/PDPAMemo', title: 'PDPA Memo'});$router.push('/PDPAMemo')">
      Step (4/4) PDPA Memo
    </van-cell>
