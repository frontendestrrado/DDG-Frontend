  ...
  <div class="DocumentChecklist bodybox">
    ...
    >
      ...
      <van-field name="Documents" label="Documents" >
        <template #input>
          <van-uploader v-model="settlor_photo_file" :disabled="isDone" :after-read="afterRead" accept="*" :max-count="1" @click-preview="goDetail1(settlor_photo_file)"/>
        </template>
      </van-field>
      <van-field
      ...
      <van-field name="Documents" label="Documents" >
        <template #input >
          <van-uploader v-model="proof_of_current_file" :after-read="afterRead2" accept="*" :max-count="1" :disabled="isDone" @click-preview="goDetail1(proof_of_current_file)"/>
        </template>
      </van-field>
      <van-field
