				...
				<div class="inputBox">
					...
					<van-form validate-first @failed="onFailed" @submit="verifyCode">
						<van-field
                            ...
                            :rules="[{ required: true, message: '请输入Full Name / Company Name' }]"
                          />
						<van-field
                        ...
                        <van-field
                            ...
                            >
                            <van-button class="SMSconfirm" slot="button" native-type="button" :disabled='phoneList.isSms' @click="sendCode();">发送验证码</van-button>
                        </van-field>
						<van-field
                            ...
                            :rules="[{ required: true, message: '请输入Residential Address' }]"
                          />
						<van-field
                        ...
                        <van-field
                          ...
                          />
                    	<van-button class="loginBtn" type="default" native-type="submit">Sign Up</van-button>
					</van-form>
