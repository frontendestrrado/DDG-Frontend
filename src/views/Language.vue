...
<style scoped>
	/deep/ .van-dropdown-menu, /deep/ .van-dropdown-menu__item, /deep/ .van-dropdown-menu__bar{background-color: #fff;box-shadow:none;}
	/deep/ .van-dropdown-menu__title::after{display: none;}
	.language{background-color: #fff;min-height: calc(100vh - 80px);}
	@media screen and (max-width: 768px){
		.language{background-color: #fff;min-height: calc(100vh - 60px);}
	}
</style>